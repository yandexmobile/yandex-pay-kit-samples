...
<img src="docs/images/main_page.png" alt="Главный экран" width="260">
...
<img src="docs/images/order_page.png" alt="Order Settings" width="260">
...
OrderSettings          — хранит OrderConfiguration (корзина, валюта, методы)
      ↓
PaymentURLProvider     — запрашивает URL у API при каждой оплате, хранит isLoading / errorMessage
      ↓
...
```swift
// Создать новый заказ и получить URL (вызывается автоматически при нажатии на кнопку оплаты)
let url = await urlProvider.resolvePaymentURL()

// Сбросить ошибку (например, после изменения корзины)
...
<img src="docs/images/modules/auth_view.png" alt="Auth" width="400">
...
<img src="docs/images/modules/cp_qr_unauthorized.png" alt="CP QR Quick Pay — без авторизации" width="260"> <img src="docs/images/modules/cp_qr_authorized.png" alt="CP QR Quick Pay — авторизован" width="260">
...
<img src="docs/images/modules/redirect_base.png" alt="Redirects" width="260">
...
<img src="docs/images/modules/inventory_page.png" alt="Inventory" width="260">
...
<img src="docs/images/modules/assistant_unauthorized.png" alt="Assistant — без авторизации" width="360"> <img src="docs/images/modules/assistant_authorized.png" alt="Assistant — авторизован" width="360">
